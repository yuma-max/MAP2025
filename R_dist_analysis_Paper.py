...
def plot_shell_fraction_quad_cmap(sim_num_list, snapshots_to_analyze, infopath = "/home/takeichi/MAP/Code_Yuma_2025/Code/Datafiles/Data100_new_edited_Z.csv"):
    ...
    fig.suptitle("Radial Mass Distribution", fontsize=20, x=0.5, ha='center')
    for i, sim_num in enumerate(sim_num_list):
        ...
        ax2.plot(bin_centers, total_r2_density, color='black', linewidth=3, label='Total Accreted')
            ...
            for halo in survived_halos:
                ax[i,0].plot(bin_centers, , label=labels[i], color=colors_for_plot[i], linestyle=linestyles[i])
