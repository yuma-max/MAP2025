...
def plot_radial_distribution(sim_num, snapshots_to_analyze, infopath = "/home/takeichi/MAP/Code_Yuma_2025/Code/Datafiles/Data100_new_edited_Z.csv"):
    ...
    if infall_mass_map:
        ...
        norm = mcolors.LogNorm(vmin=min_infall_mass, vmax=max_infall_mass, clip = True)
    ...
    for snapshot_str in snapshots_to_analyze:
        ...
        for item in halo_ids:
            ...
            try:
                ...
                if not sub_survive.empty:
                    ...
                    if cmap and norm and item in infall_mass_map:
                        colors_for_plot.append(cmap(norm(infall_mass_map[item])))
                    else:
        ...
        if cmap and norm:
            ...
            cbar.set_label('Infall Mass [$M_{\odot}$]')

        filename = f"r_dist_4-panel_infallmass_snap{SNAPSHOT_TO_ANALYZE:06d}.png"
